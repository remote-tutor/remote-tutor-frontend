  ...
  <div>
    <v-card>
      <v-card-title>
        ...
        <v-btn fab color="green" small :disabled="invalidGeneration" @click="generateCodes" :loading="loadingGenerating">
        ...
        <v-row>
          ...
          <v-col cols="6" md="4">
            <v-text-field
                ...
                @input="getCodes"
                @click:append-outer="generateAccessPDF"
                :loading="loadingPDF"
...
export default {
  ...
  methods: {
    ...
    generateAccessPDF() {
      ...
      api({
        method: "GET",
        url: "/admin/videos/codes/access/pdf",
        responseType: 'blob',
        params: {
          videoID: this.video.ID,
          page: 0,
